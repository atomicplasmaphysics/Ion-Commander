...
struct TDC4HM_struct
{
	...
	__int32				i32NumberOfDAQLoops;
	unsigned __int32	driver_revision;
	double				veto_start;
	double 				veto_end;
	double 				filter_mask_1;
	double 				filter_mask_2;
	double				dc_offset[5];
};
...
struct TDC8HP_struct
{
	...
	double				veto_start;
	double				veto_end;
	unsigned __int64	filter_mask_1;
	unsigned __int64	filter_mask_2;
	__int32				i32AdvancedTriggerChannel;
	double				i32AdvancedTriggerChannel_start;
	double				i32AdvancedTriggerChannel_stop;
	double				Time_zero_channel_offset_s;
	unsigned __int64	veto_exclusion_mask;
};




struct TDC8HQ_struct
{
	unsigned __int64 RisingEnable_p61;
	unsigned __int64 FallingEnable_p62;
	__int32 TriggerEdge_p63;
	...
	__int32 i32NumberOfDAQLoops;
	unsigned __int32 TDC8HQ_DriverVersion;
	__int32 iTriggerChannelMask;
	__int32 iTime_zero_channel;
	...
	unsigned __int64 ui64RollOvers;
	unsigned __int32 ui32AbsoluteTimeStamp;
	unsigned __int64 ui64TDC8HQ_AbsoluteTimeStamp;

	__int32 channel_offset_for_rising_transitions;

	__int32 UseATC1; // use ATC1
	__int32 max_parameter_900_index;
...
public:
	...
	static const unsigned __int32 DAQ_ID_HM1 = 0x000001;
	static const unsigned __int32 DAQ_ID_TDC8 = 0x000002;
	static const unsigned __int32 DAQ_ID_CAMAC = 0x000003;
	static const unsigned __int32 DAQ_ID_2HM1 = 0x000004;
	static const unsigned __int32 DAQ_ID_2TDC8 = 0x000005;
	static const unsigned __int32 DAQ_ID_HM1_ABM = 0x000006;
	static const unsigned __int32 DAQ_ID_TDC8HP = 0x000008;
	static const unsigned __int32 DAQ_ID_TCPIP = 0x000009;
	static const unsigned __int32 DAQ_ID_TDC8HPRAW = 0x000010;
	static const unsigned __int32 DAQ_ID_FADC8 = 0x000011;		// for fADC8
	static const unsigned __int32 DAQ_ID_FADC4 = 0x000012;		// for fADC4
	static const unsigned __int32 DAQ_ID_TDC4HM = 0x000013;
	static const unsigned __int32 DAQ_ID_cTDCx = 0x000014;		// for cTDCx
	static const unsigned __int32 DAQ_ID_TDC8HQ = 0x000015;		// for TDC8HQ
	static const unsigned __int32 DAQ_ID_RAW32BIT = 100;
	static const unsigned __int32 DAQ_ID_SIMPLE = 101;
	...
	void            GetTDCDataArray(__int32* tdc, __int32 max_channel, __int32 max_hits);
...
private:
	...
	__int32			WriteTDC8HQHeader_v1();
	__int32			WriteHM1Header();
	__int32			WriteTDC4HMHeader();
...
public:
	...
	HM1_struct		HM1;
	TDC8HQ_struct	TDC8HQ;
	TDC8HP_struct	TDC8HP;
	TDC4HM_struct	TDC4HM;
